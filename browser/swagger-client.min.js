...
"use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject")},SwaggerSpecConverter=module.exports=function(){this.errors=[],this.warnings=[],this.modelMap={}};SwaggerSpecConverter.prototype.setDocumentationLocation=function(e){this.docLocation=e},SwaggerSpecConverter.prototype.getAbsoluteBasePath=function(e,t){if("undefined"==typeof e||"undefined"==typeof t||""===e||0===t.indexOf("http://")||0===t.indexOf("https://"))return t;if("/"===e.slice(-1));else{var r=e.lastIndexOf("/");r>0&&(e=e.substring(0,r))}var i=t,s=i.split("/"),n=s[0]+"//"+s[2];if(0===e.indexOf("http"))return e+i;if("/"==e.substring(0,1)){var a,r=t.lastIndexOf("/"),o=t.substring(0,r);return a="/"==e.charAt(e.length-1)?e.substring(0,e.length-1):e,o+a}return""===e?n+e:n+"/"+e},SwaggerSpecConverter.prototype.convert=function(e,t,r){if(!e||!Array.isArray(e.apis))return this.finish(r,null);this.clientAuthorizations=t;var i=this.getAbsoluteBasePath(this.docLocation,e.basePath);e.basePath=i;var s={swagger:"2.0"};s.originalVersion=e.swaggerVersion,this.apiInfo(e,s),this.securityDefinitions(e,s),e.basePath&&this.setDocumentationLocation(e.basePath);var n,a=!1;for(n=0;n<e.apis.length;n++){var o=e.apis[n];Array.isArray(o.operations)&&(a=!0)}a?(this.declaration(e,s),this.finish(r,s)):this.resourceListing(e,s,r)},SwaggerSpecConverter.prototype.declaration=function(e,t){var r,i,s,n;if(e.apis){var a=this.getAbsoluteBasePath(this.docLocation,e.basePath);e.basePath=a,0===e.basePath.indexOf("http://")?(s=e.basePath.substring("http://".length),n=s.indexOf("/"),n>0?(t.host=s.substring(0,n),t.basePath=s.substring(n)):(t.host=s,t.basePath="/")):0===e.basePath.indexOf("https://")?(s=e.basePath.substring("https://".length),n=s.indexOf("/"),n>0?(t.host=s.substring(0,n),t.basePath=s.substring(n)):(t.host=s,t.basePath="/")):t.basePath=e.basePath;var o;if(e.authorizations&&(o=e.authorizations),e.consumes&&(t.consumes=e.consumes),e.produces&&(t.produces=e.produces),_.isObject(e))for(r in e.models){var p=e.models[r],u=p.id||r;this.modelMap[u]=r}for(i=0;i<e.apis.length;i++){var f=e.apis[i],c=f.path,h=f.operations;this.operations(c,e.resourcePath,h,o,t)}var l=e.models||{};this.models(l,t)}},SwaggerSpecConverter.prototype.models=function(e,t){if(_.isObject(e)){var r;t.definitions=t.definitions||{};for(r in e){var i,s=e[r],n=[],a={properties:{}};for(i in s.properties){var o=s.properties[i],p={};this.dataType(o,p),o.description&&(p.description=o.description),o["enum"]&&(p["enum"]=o["enum"]),"boolean"==typeof o.required&&o.required===!0&&n.push(i),"string"==typeof o.required&&"true"===o.required&&n.push(i),a.properties[i]=p}n.length>0&&(a["enum"]=n),a.required=s.required,t.definitions[r]=a}}},SwaggerSpecConverter.prototype.extractTag=function(e){var t=e||"default";return(0===t.indexOf("http:")||0===t.indexOf("https:"))&&(t=t.split(["/"]),t=t[t.length-1].substring()),t.endsWith(".json")&&(t=t.substring(0,t.length-".json".length)),t.replace("/","")},SwaggerSpecConverter.prototype.operations=function(e,t,r,i,s){if(Array.isArray(r)){var n;s.paths||(s.paths={});var a=s.paths[e]||{},o=this.extractTag(t);s.tags=s.tags||[];var p=!1;for(n=0;n<s.tags.length;n++){var u=s.tags[n];u.name===o&&(p=!0)}for(p||s.tags.push({name:o}),n=0;n<r.length;n++){var f=r[n],c=(f.method||f.httpMethod).toLowerCase(),h={tags:[o]},l=f.authorizations;if(l&&0===Object.keys(l).length&&(l=i),"undefined"!=typeof l){var d;for(var g in l){h.security=h.security||[];var m=l[g];if(m){var y=[];for(var v in m)y.push(m[v].scope);d={},d[g]=y,h.security.push(d)}else d={},d[g]=[],h.security.push(d)}}f.consumes?h.consumes=f.consumes:s.consumes&&(h.consumes=s.consumes),f.produces?h.produces=f.produces:s.produces&&(h.produces=s.produces),f.summary&&(h.summary=f.summary),f.notes&&(h.description=f.notes),f.nickname&&(h.operationId=f.nickname),f.deprecated&&(h.deprecated=f.deprecated),this.authorizations(l,s),this.parameters(h,f.parameters,s),this.responseMessages(h,f,s),a[c]=h}s.paths[e]=a}},SwaggerSpecConverter.prototype.responseMessages=function(e,t){if(_.isObject(t)){var r={};this.dataType(t,r),!r.schema&&r.type&&(r={schema:r}),e.responses=e.responses||{};var i=!1;if(Array.isArray(t.responseMessages)){var s,n=t.responseMessages;for(s=0;s<n.length;s++){var a=n[s],o={description:a.message};200===a.code&&(i=!0),a.responseModel&&(o.schema={$ref:"#/definitions/"+a.responseModel}),e.responses[""+a.code]=o}}i?e.responses["default"]=r:e.responses[200]=r}},SwaggerSpecConverter.prototype.authorizations=function(e){!_.isObject(e)},SwaggerSpecConverter.prototype.parameters=function(e,t){if(Array.isArray(t)){var r;for(r=0;r<t.length;r++){var i=t[r],s={};if(s.name=i.name,s.description=i.description,s.required=i.required,s["in"]=i.paramType,"body"===s["in"]&&(s.name="body"),"form"===s["in"]&&(s["in"]="formData"),i["enum"]&&(s["enum"]=i["enum"]),i.allowMultiple===!0||"true"===i.allowMultiple){var n={};if(this.dataType(i,n),s.type="array",s.items=n,i.allowableValues){var a=i.allowableValues;"LIST"===a.valueType&&(s["enum"]=a.values)}}else this.dataType(i,s);"undefined"!=typeof i.defaultValue&&(s["default"]=i.defaultValue),e.parameters=e.parameters||[],e.parameters.push(s)}}},SwaggerSpecConverter.prototype.dataType=function(e,t){if(_.isObject(e)){e.minimum&&(t.minimum=e.minimum),e.maximum&&(t.maximum=e.maximum),e.format&&(t.format=e.format),"undefined"!=typeof e.defaultValue&&(t["default"]=e.defaultValue);var r=this.toJsonSchema(e);r&&(t=t||{},r.type&&(t.type=r.type),r.format&&(t.format=r.format),r.$ref&&(t.schema={$ref:r.$ref}),r.items&&(t.items=r.items))}},SwaggerSpecConverter.prototype.toJsonSchema=function(e){if(!e)return"object";var t=e.type||e.dataType||e.responseClass||"",r=t.toLowerCase(),i=(e.format||"").toLowerCase();if(0===r.indexOf("list[")){var s=t.substring(5,t.length-1),n=this.toJsonSchema({type:s});return{type:"array",items:n}}if("int"===r||"integer"===r&&"int32"===i)return{type:"integer",format:"int32"};if("long"===r||"integer"===r&&"int64"===i)return{type:"integer",format:"int64"};if("integer"===r)return{type:"integer",format:"int64"};if("float"===r||"number"===r&&"float"===i)return{type:"number",format:"float"};if("double"===r||"number"===r&&"double"===i)return{type:"number",format:"double"};if("string"===r&&"date-time"===i||"date"===r)return{type:"string",format:"date-time"};if("string"===r)return{type:"string"};if("file"===r)return{type:"file"};if("boolean"===r)return{type:"boolean"};if("boolean"===r)return{type:"boolean"};if("array"===r||"list"===r){if(e.items){var a=this.toJsonSchema(e.items);return{type:"array",items:a}}return{type:"array",items:{type:"object"}}}return e.$ref?{$ref:this.modelMap[e.$ref]?"#/definitions/"+this.modelMap[e.$ref]:e.$ref}:"void"===r||""===r?{}:this.modelMap[e.type]?{$ref:"#/definitions/"+this.modelMap[e.type]}:{type:e.type}},SwaggerSpecConverter.prototype.resourceListing=function(e,t,r){var i,s=0,n=this,a=e.apis.length,o=t;for(0===a&&this.finish(r,t),i=0;a>i;i++){var p=e.apis[i],u=p.path,f=this.getAbsolutePath(e.swaggerVersion,this.docLocation,u);p.description&&(t.tags=t.tags||[],t.tags.push({name:this.extractTag(p.path),description:p.description||""}));var c={url:f,headers:{accept:"application/json"},on:{},method:"get"};c.on.response=function(e){s+=1;var t=e.obj;t&&n.declaration(t,o),s===a&&n.finish(r,o)},c.on.error=function(e){console.error(e),s+=1,s===a&&n.finish(r,o)},this.clientAuthorizations&&"function"==typeof this.clientAuthorizations.apply&&this.clientAuthorizations.apply(c),(new SwaggerHttp).execute(c)}},SwaggerSpecConverter.prototype.getAbsolutePath=function(e,t,r){if("1.0"===e&&t.endsWith(".json")){var i=t.lastIndexOf("/");i>0&&(t=t.substring(0,i))}var s=t;return 0===r.indexOf("http://")||0===r.indexOf("https://")?s=r:(t.endsWith("/")&&(s=t.substring(0,t.length-1)),s+=r),s=s.replace("{format}","json")},SwaggerSpecConverter.prototype.securityDefinitions=function(e,t){if(e.authorizations){var r;for(r in e.authorizations){var i=!1,s={},n=e.authorizations[r];if("apiKey"===n.type)s.type="apiKey",s["in"]=n.passAs,s.name=n.keyname||r,i=!0;else if("oauth2"===n.type){var a,o=n.scopes||[],p={};for(a in o){var u=o[a];p[u.scope]=u.description}if(s.type="oauth2",a>0&&(s.scopes=p),n.grantTypes){if(n.grantTypes.implicit){var f=n.grantTypes.implicit;s.flow="implicit",s.authorizationUrl=f.loginEndpoint,i=!0}if(n.grantTypes.authorization_code&&!s.flow){var c=n.grantTypes.authorization_code;s.flow="accessCode",s.authorizationUrl=c.tokenRequestEndpoint.url,s.tokenUrl=c.tokenEndpoint.url,i=!0}}}i&&(t.securityDefinitions=t.securityDefinitions||{},t.securityDefinitions[r]=s)}}},SwaggerSpecConverter.prototype.apiInfo=function(e,t){if(e.info){var r=e.info;t.info={},r.contact&&(t.info.contact={},t.info.contact.email=r.contact),r.description&&(t.info.description=r.description),r.title&&(t.info.title=r.title),r.termsOfServiceUrl&&(t.info.termsOfService=r.termsOfServiceUrl),(r.license||r.licenseUrl)&&(t.license={},r.license&&(t.license.name=r.license),r.licenseUrl&&(t.license.url=r.licenseUrl))}else this.warnings.push("missing info section")},SwaggerSpecConverter.prototype.finish=function(e,t){e(t)};
